...
const createSanityUser = async (relawan_userData) => {
    ...
    const response = await fetch(`https://ln9ujpru.api.sanity.io/v2021-03-25/data/mutate/production`, {
      ...
      body: JSON.stringify({
        mutations: [
          {
            create: {
              _type: 'user-relawan', // Ganti dengan jenis dokumen pengguna di Sanity Anda
              name: relawan_userData.name,
              email: relawan_userData.email,
              password: relawan_userData.password,
              type: relawan_userData.type,
            },
          },
        ],
      }),

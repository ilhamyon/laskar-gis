...
function Screening() {
  ...
  async function fetchSanityData() {
    try {
      ...
      const filteredData = sanityData.filter(item => item.user?._ref === relawan_id);
  ...
  const createScreening = async (relawan_userData) => {
          ...
          mutations: [
            {
              create: {
                ...
                user: {
                  _type: 'reference',
                  _ref: relawan_id // Assuming relawan_userData.userId contains the ID of the user document
                },
                question1: relawan_userData.question1,
                question2: relawan_userData.question2,
                question3: relawan_userData.question3,
                question4: relawan_userData.question4,
                question5: relawan_userData.question5,
                question6: relawan_userData.question6,
                question7: relawan_userData.question7,
                question8: relawan_userData.question8,
              },
            },
          ],
        }),
